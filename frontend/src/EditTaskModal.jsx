...
const EditTaskModal = ({ isOpen, closeModal, handleEditTask, editTask }) => {
    const [newTaskName, setNewTaskName] = useState(editTask.taskName);
    const [newPriority, setNewPriority] = useState(editTask.priority);
    const [newLabel, setNewLabel] = useState(editTask.label);
